...
<script src='https://kit.fontawesome.com/a076d05399.js'></script>
    ...
    <%String email=String.valueOf(session.getAttribute("email")); %>
            <center><h2>WareHouse Automation Systems</h2></center>
            ...
            <a href="myWarehouses.jsp">My Warehouses <i class='fab fa-elementor'></i></a>
            <a href="changeDetails.jsp">Change Details <i class="fa fa-edit"></i></a>
            <a href="addNewWarehouse.jsp">Rent New WareHouse<i class="fa fa-edit"></i></a>
